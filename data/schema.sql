...
('PLAYER_DIALOGUE_AUDIO_ENABLED', 'true', 'Play TTS for the selected squadmate when sending Chat, Whisper, or Shout messages. Speech bubbles and NPC response audio are unchanged.'),
