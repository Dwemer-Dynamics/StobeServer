(function (global) {
    ...
    function mount(root, options) {
        ...
        const apiUrl = String(options.apiUrl || 'api/stobe_npc_history.php');
        ...
        root.innerHTML = `
            <div class="npc-event-history-shell span-2">
                <section class="npc-event-history-section">
                    ...
                    <textarea id="npc-event-history-text-${npcId}" class="npc-event-history-text" data-history-event-text maxlength="4000" placeholder="A gave B a ration pack."></textarea>
        ...
        async function searchNpcRecipients() {
            ...
            const query = new URLSearchParams({operation: 'list', search: search});
            try {
        ...
        function renderEvents(events) {
            ...
            ['Type', 'Event', 'People Present', 'Kenshi Time', 'Time (UTC)', ''].forEach(function (label) {
    ...
    global.stobeNpcEventHistory = {mount: mount};
})(window);
