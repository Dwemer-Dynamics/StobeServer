                        ...
                        <?php foreach ($menuItems as $item): ?>
                            <li>
                                ...
                                <?php if ($item['page'] !== ''): ?>
                                    ...
                                    <?php if ($item['page'] === 'home.php' && ($currentPage === 'index.php' || $currentPage === 'stobe.php')) { $isActive = true; } ?>
                                <?php endif; ?>
                                <?php $isRealLink = (strval($item['href']) !== '' && strval($item['href']) !== '#'); ?>
                                <a class="dropdown-item<?= $isActive ? ' active' : '' ?>" href="<?= htmlspecialchars($item['href'], ENT_QUOTES, 'UTF-8') ?>"<?= $isRealLink ? ' target="_top"' : '' ?>>
